...
port = 54000
players = 20          # Total slots including bots, from 1 to 32.
teams = 2             # From 1 to 20; cannot exceed players.
bots = 10             # Set 0 for humans only; cannot exceed players.
friendly_fire = false
...
New players and bots join the least-populated team. Team 1 uses the original red outline, team 2 uses blue; additional distinct colors are generated by subdividing the color wheel. All players, including the local player, show their team outline. Friendly fire is disabled by default; all players still collide physically. Respawning retains the team, while a reclaimed slot is assigned to the smallest team again.
