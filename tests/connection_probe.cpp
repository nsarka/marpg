...
int main(int argc,char** argv) {
    ...
    if(s.port!=std::stoi(argv[1]) || s.teams!=3 || s.slots!=6 || s.bots!=0 || s.jabDamage!=27 || s.hookDamage!=41 || s.triggerDamage!=7 || s.boundsDamage!=9 || s.triggerInterval!=1.0 || s.boundsInterval!=.25)return 3;
