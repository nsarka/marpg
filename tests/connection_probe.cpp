...
int main(int argc,char** argv) {
    ...
    if(s.port!=std::stoi(argv[1]) || s.teams!=3 || s.players!=6 || s.bots!=0 || s.jabDamage!=27 || s.hookDamage!=41 || s.triggerDamage!=7 || s.boundsDamage!=9 || s.triggerBpm!=60 || s.boundsBpm!=240)return 3;
